...
{
    [CustomPropertyDrawer(typeof(FolderIconData))]
    public class FolderIconDataDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            var typeSelected = (FolderIconData.KeyType)Enum.GetValues(typeof(FolderIconData.KeyType)).GetValue(folderKeyType.enumValueIndex);
            folderKeyType.enumValueIndex = (int)(FolderIconData.KeyType)EditorGUI.EnumPopup(position, typeSelected);
